...
import com.network.opmsocket.backend.config.UploadProperties;
...
public class UploadService {
    ...
    public String store(MultipartFile file) throws IOException {
        ...
        if (file.getSize() > props.getMaxSize().toBytes()) {
            throw new IllegalArgumentException("File too large. Max size is " + props.getMaxSize());
        }
        ...
        Path uploadDir = Paths.get(props.getDir());
        ...
        // Return the relative URL that clients can use (reflects configured dir)
        return "/" + props.getDir() + "/" + filename;
    }

    private boolean isAllowedType(MultipartFile file, String contentType) throws IOException {
        try {
